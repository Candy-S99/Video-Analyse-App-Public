...
import { createJob, getJobStatus, getJobOutput, getOutputArtifact, createJobOutputArchive, getJobResult, getJobEvents, getAllJobEvents, listJobs, getConfig, updateConfig, updateGeminiApiKey, deleteGeminiApiKey, cancelJob, clearHistory, clearAllLogs, getScreenshots, getScreenshot, previewRetention, cleanupRetention } from '../controllers/jobController';
...
router.post('/jobs/:job_id/output/archive', createJobOutputArchive);
